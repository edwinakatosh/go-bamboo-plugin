[@s.select labelKey="agent.capability.type.capability.go.key" name="goExecutableKind"
...
[#list capabilityType.executableTypes.keySet() as executableTypeKey]
  [@ui.bambooSection dependsOn="goExecutableKind" showOn=executableTypeKey]
    [@s.textfield labelKey="agent.capability.type.capability.go.value" name=executableTypeKey value=""
